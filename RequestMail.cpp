// RequestMail.cpp: implementation of the CMail class.
//
//////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////
CRequestMail::CRequestMail()
{

}

CRequestMail::CRequestMail(string title,string body,string id)
{
	MailBody = body;
	MailId = id;
	MailTitle = title;
...
CList<CString,CString&>* CRequestMail::parseResourceList(string body)
{
